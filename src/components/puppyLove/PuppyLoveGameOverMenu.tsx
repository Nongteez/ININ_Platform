...
interface PuppyLoveGameOverMenuProps {
  onRestart: () => void;
}
...
export function PuppyLoveGameOverMenu({ onRestart }: PuppyLoveGameOverMenuProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-40 flex items-center justify-center px-6 backdrop-blur-[3px]"
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      >
        <h2 className="text-center font-light uppercase text-white/95 mb-10 text-3xl md:text-[2.75rem] leading-none tracking-[0.28em] pl-[0.28em] [font-family:Georgia,'Times_New_Roman',serif] [text-shadow:0_0_48px_rgba(251,113,133,0.4),0_0_96px_rgba(251,113,133,0.15),0_2px_4px_rgba(0,0,0,0.8)]">
          Game Over
        </h2>
        ...
        <nav className="flex flex-col gap-3">
          ...
          >
            <RotateCcw className="w-4 h-4 text-pink-200/90" />
            <span className="text-sm font-medium tracking-[0.12em]">Restart Game</span>
          </motion.button>
